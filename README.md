...
#### Contact
As we work after hours, not all communication will be made during regular business hours (Monday-Friday, 9am-5pm, NZST/NZDST excluding holidays) and we will envevour to return any contact requests within one business day. We appreciate communication in a text-based medium, but understand that not all discussions are easily done this way. We’re happy to speak to you on the phone, over Skype/FaceTime etc, or in person if you are in the [MY CITY] area, keeping in mind that any decisions that are made will be written down and require your written approval.
...
You guarantee to us that any elements of text, graphics, photos, designs, trademarks, or other artwork that you provide us for inclusion in the application are either owned by you, or that you have permission to use them.
